...
namespace Buildersoft.Andy.X.Core.Abstractions.Services.CoreState
{
    public interface ICoreService
    {
        ...
        bool CreateTenantToken(string tenant, TenantToken tenantToken, bool notifyCluster = true);
        ...
        bool UpdateTenantRetention(string tenant, RetentionType retentionType, string name, long timeToLive, bool notifyCluster = true);
        bool DeleteTenantRetention(string tenant, long retentionId, bool notifyCluster = true);
        bool DeleteTenantRetention(string tenant, RetentionType retentionType, bool notifyCluster = true);

        bool CreateProduct(string tenant, string productName, string description);
        bool CreateProduct(string tenant, string productName, string description, bool isAuthorizationEnabled, bool notifyCluster = true);
        ...
        bool CreateProductToken(string tenant, string product, ProductToken productToken, bool notifyCluster = true);
        ...
        bool UpdateProductRetention(string tenant, string product, RetentionType retentionType, string name, long timeToLive, bool notifyCluster = true);
        bool DeleteProductRetention(string tenant, string product, long retentionId, bool notifyCluster = true);
        bool DeleteProductRetention(string tenant, string product, RetentionType retentionType, bool notifyCluster = true);

        bool CreateComponent(string tenant, string product, string componentName, string description);
        bool CreateComponent(string tenant, string product, string componentName, string description, bool isTopicAutomaticCreation, bool isSchemaValidationEnabled, bool isAuthorizationEnabled, bool isSubscriptionAllowToCreate, bool isProducerAllowToCreate, bool notifyCluster = true);
        ...
        bool UpdateComponentSettings(string tenant, string product, string componentName, bool isTopicAutomaticCreation, bool isSchemaValidationEnabled, bool isAuthorizationEnabled, bool isSubscriptionAllowToCreate, bool isProducerAutomaticCreation,bool notifyCluster = true);
        ...
        bool CreateComponentToken(string tenant, string product, string component, ComponentToken componentToken, bool notifyCluster = true);
        ...
        bool UpdateComponentRetention(string tenant, string product, string component, RetentionType retentionType, string name, long timeToLive, bool notifyCluster = true);
        bool DeleteComponentRetention(string tenant, string product, string component, long retentionId, bool notifyCluster = true);
        bool DeleteComponentRetention(string tenant, string product, string component, RetentionType retentionType, bool notifyCluster = true);

        bool CreateTopic(string tenant, string product, string component, string topic, string description, bool notifyCluster = true);
        bool CreateTopic(string tenant, string product, string component, string topic, string description, TopicSettings topicSettings, bool notifyCluster = true);
        ...
        bool DeleteSubscription(string tenant, string product, string component, string topic, string subscription, bool notifyCluster = true);
