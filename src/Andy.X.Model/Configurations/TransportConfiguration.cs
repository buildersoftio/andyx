namespace Buildersoft.Andy.X.Model.Configurations
{
    public class TransportConfiguration
    {
        ...
        // If the client doesn't send an initial handshake message within this time interval, the connection is closed. This is an advanced setting that should only be modified if handshake timeout errors are occurring due to severe network latency.
